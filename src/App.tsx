        ...
        <div className="container-app">
          <div className="h-20 flex items-center justify-between">
            ...
            <nav className="hidden sm:flex gap-1 text-sm">
              ...
              <NavLink to="/teleconsulta" className={({ isActive }) => `px-4 py-2 rounded-xl font-semibold transition-all duration-300 ${isActive ? 'bg-blue-600 text-white shadow-large' : 'bg-blue-600 text-white shadow-medium hover:bg-blue-700 hover:shadow-large hover:-translate-y-0.5'}`}>📹 Teleconsulta</NavLink>
            </nav>
          </div>
          {open && (
            <nav className="sm:hidden pb-3 -mt-2 space-y-1">
              ...
              <NavLink onClick={() => setOpen(false)} to="/teleconsulta" className={({ isActive }) => `block px-3 py-2 rounded-md font-semibold ${isActive ? 'bg-blue-600 text-white shadow-medium' : 'bg-blue-600 text-white hover:bg-blue-700'}`}>📹 Teleconsulta</NavLink>
            </nav>
          )}
        </div>
      </header>
